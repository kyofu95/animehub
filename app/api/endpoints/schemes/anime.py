...
class BaseAnime(BaseModel):
    ...
    total_number_of_episodes: int | None = Field(
        ...
        description="Total number of episodes in the anime, if known.",
    )
    airing_status: AiringStatus = Field(
        title="Airing Status",
        description="Current airing status of the anime (e.g., ongoing, completed).",
    )
    ...
    airing_end: date | None = Field(
        ...
        description="The date when the anime ended airing, if applicable.",
    )
...
class DetailedAnime(BaseAnime):
    ...
    genres: list[GenreRequest] | None = Field(
        None,
        title="Genres",
        description="A list of genres associated with the anime.",
    )
    studios: list[StudioRequest] | None = Field(
        None,
        title="Studios",
        description="A list of animation studios involved in the anime.",
    )

    franchise: FranchiseRequest | None = Field(
        None,
        title="Franchise",
        description="The franchise this anime belongs to, if applicable.",
    )
